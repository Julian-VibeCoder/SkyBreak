...
RUN cd frontend && npm ci && npm run build || echo "build attempted"
...
COPY --from=builder /app/skybreak.db . || true
COPY --from=builder /app/frontend/build ./frontend/build
COPY --from=builder /app/frontend/index.html ./frontend/index.html || true
